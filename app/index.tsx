...
import image from ".././assets/images/social2.jpg";
    ...
    >
      <View
        style={{
          ...
          paddingHorizontal: sizes.marginSM * 2,
          alignItems: "center",
        }}
      >
        <Image
      ...
      <View
        style={{
          ...
          position: "absolute",
          bottom: sizes.marginSM * 2,
        }}
      >
        <Text style={{ color: Colors.light.tint, fontSize: sizes.fontSize[5] }}>
          CampusHubConnect
        </Text>
        <Text
          style={{ color: Colors.light.text, fontSize: sizes.fontSize[5] + 5 }}
        >
        ...
        >
          ...
          <View>
            ...
            <Text style={{ color: Colors.light.tint }}>
              Stay updated with events happening on campus with the click on a
              button
            </Text>
          </View>
